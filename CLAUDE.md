...
1. **每次更新完产品功能及优化完代码之后，都要去遍历并更新所有相关文档**（包括 CLAUDE.md、PROJECT_BRIEF.md、TASKS.md、DECISIONS.md、README.md、TODO.md、DEV_GUIDE.md、根目录 CLAUDE.md 等），确保文档与功能完全一致。
2. **每次提交到 Git 之前，都要检查功能更新及代码更新后，是否同步完成了文档的更新。如果没有完成，请更新完文档再提交 Git。** 禁止代码已改但文档未更新就提交的情况。
